        ...
        >
          <div className="glass flex items-center gap-2 rounded-full p-1.5 shadow-[0_18px_50px_-12px_rgba(0,0,0,0.85)]">
            <a
              ...
              className="grid h-11 w-11 shrink-0 place-items-center rounded-full border border-ink/10 text-blue-600 transition-colors active:bg-ink/10"
            >
            ...
            <button
              ...
              className="flex h-11 flex-1 items-center justify-center gap-2 rounded-full bg-linear-to-r from-blue-400 to-blue-300 text-[0.875rem] font-semibold text-canvas active:brightness-110"
            >
              Register your site
